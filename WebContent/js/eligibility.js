...
function validateForm() {
	...
	if (selectSkilled.value === "selSkilled") {
		...
		document.getElementById("skillinvalid").innerHTML = "*Please enter the appropriate value";
	...
	if (selectTotal.value === "selTotal") {
		...
		document.getElementById("totalskillinvalid").innerHTML = "*Please select an appropriate value";
